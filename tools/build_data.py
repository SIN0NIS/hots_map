...
# 리플레이 구조물(코어·요새) 좌표가 그림의 해당 건물에 앉는지로 확인해 정한 값이다.
# 2026-08-05 재추출본에서 난투 3개(브락시스 전초기지·공업 지구·은빛 도시)의 구도가
# 바뀌어, 구 이미지 대비 «배율·이동»을 정규화 상관(0.77~0.97)으로 풀어 갱신했다.
CAL_OVERRIDE = {
    "braxis_outpost":      {"L": -38.7, "R": 285.6, "B": 15.7, "T": 199.2},
    "lost_cavern":         {"L": -2.0,  "R": 250.0, "B": 35.8, "T": 177.8},
    "silver_city":         {"L": -1.3,  "R": 253.1, "B": 35.9, "T": 179.1},
    "industrial_district": {"L": -56.2, "R": 270.7, "B": 31.7, "T": 216.1},
}
